...
- `jibExportDockerContext` generates different directory layout in `build/jib-docker-context` than before, and the content of the generated `Dockerfile` has also been changed accordingly
