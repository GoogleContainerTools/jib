...
- New `includes` and `excludes` options for `jib.extraDirectories.paths` to specify a subset of files to copy using glob patterns. ([#2564](https://github.com/GoogleContainerTools/jib/issues/2564))
