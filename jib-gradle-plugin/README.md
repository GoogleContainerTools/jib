...
`containerizingMode` | `String` | `exploded` | If set to `packaged`, puts the JAR artifact built by the Gradle Java plugin in the final image. If set to `exploded` (default), containerizers individual `.class` files and resources files.
