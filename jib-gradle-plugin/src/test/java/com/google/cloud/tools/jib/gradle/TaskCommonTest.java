...
public class TaskCommonTest {
  ...
  public void testGetWarTask_normalWarProject() {
    ...
    assertThat(warTask instanceof War).isNotNull();
  }
  ...
  public void testGetBootWarTask_bootWarProject() {
    ...
    assertThat(bootWarTask instanceof BootWar).isNotNull();
  }

  @Test
  public void testFinishUpdateCheck_correctMessageReturned() {
