...
- `jib:exportDockerContext` generates different directory layout in `target/jib-docker-context` than before, and the content of the generated `Dockerfile` has also been changed accordingly
