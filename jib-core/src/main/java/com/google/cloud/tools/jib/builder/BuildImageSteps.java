...
public class BuildImageSteps implements BuildSteps {
  ...
  private static final String STARTUP_FORMAT = "Containerizing application to %s...";
  private static final String SUCCESS_FORMAT = "Built and pushed image as \u001B[36m%s\u001B[0m";
