...
//        this.imageId = imageId;
    ...
    {
        return new URL(
            apiRouteBase + registryEndpointRequestProperties.getImageName() + "/manifests/" + imageDescriptor.toString());
    }
    ...
    @Override
    public Optional<ManifestDescriptor<T>> handleHttpResponseException(ResponseException responseException)
