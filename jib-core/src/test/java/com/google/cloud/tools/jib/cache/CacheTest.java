...
public class CacheTest {
  ...
  public void test_saveMetadata_noDuplicates()
    ...
    LayerEntry layerEntry1 =
        new LayerEntry(Paths.get("some", "file"), AbsoluteUnixPath.get("/extractionPath1"));
    LayerEntry layerEntry2 =
        new LayerEntry(
            Paths.get("some", "other", "file"), AbsoluteUnixPath.get("/extractionPath1"));
    LayerEntry layerEntry3 =
        new LayerEntry(Paths.get("another", "file"), AbsoluteUnixPath.get("/extractionPath2"));
    LayerEntry layerEntry4 =
        new LayerEntry(
            Paths.get("yet", "another", "file"), AbsoluteUnixPath.get("/extractionPath2"));
