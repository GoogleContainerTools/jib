...
public class BuildImageStepTest {
  ...
  public void setUp() throws DigestException {
    ...
    nonEmptyLayerHistory =
        new HistoryEntry(Instant.EPOCH.toString(), "JibBase", "jib-test", null, null);
    emptyLayerHistory =
        new HistoryEntry(Instant.EPOCH.toString(), "JibBase", "jib-test", null, true);
  ...
  public void test_generateHistoryObjects() throws ExecutionException, InterruptedException {
    ...
    HistoryEntry expectedAddedBaseLayerHistory =
        new HistoryEntry(Instant.EPOCH.toString(), null, null, "auto-generated by Jib", null);
    HistoryEntry expectedApplicationLayerHistory =
        new HistoryEntry(Instant.EPOCH.toString(), "Jib", "jib", null, null);
