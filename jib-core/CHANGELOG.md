...
- `ImageReference#isTagDigest` is deprecated; use `#getDigest` with `Optional#isPresent()`.
- `ImageReference#toStringWithTag` is deprecated in favor of `#toStringWithIdentifier`.
