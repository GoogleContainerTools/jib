...
./gradlew clean build :jib-gradle-plugin:integrationTest --tests "com.google.cloud.tools.jib.gradle.SingleProjectIntegrationTest.testDockerDaemon_containerWithTruststoreJvmArgument" --info --stacktrace