...
public class JibCli {
  ...
  //  // unfortunately we cannot verify for --target=tar://... this is required, we must do this
  // after
  ...
  //      description =
  //          "The image reference to inject into the tar configuration (required when using
  // --target tar://...)",
  //      scope = CommandLine.ScopeType.INHERIT)
  //  @SuppressWarnings("NullAway.Init") // initialized by picocli
  //  private String name;
  ...
  //        description =
  //            "credential helper for communicating with both target and base image registries,
  // either a path to the helper, or a suffix for an executable named `docker-credential-<suffix>`",
  //        scope = CommandLine.ScopeType.INHERIT)
  //    @SuppressWarnings("NullAway.Init") // initialized by picocli
  ...
  //        paramLabel = "<credential-helper>",
  //        description =
  //            "credential helper for communicating with target registry, either a path to the
  // helper, or a suffix for an executable named `docker-credential-<suffix>`",
  //        scope = CommandLine.ScopeType.INHERIT)
  //    @SuppressWarnings("NullAway.Init") // initialized by picocli
  //    private String credentialHelper;
  //
  ...
  //        paramLabel = "<credential-helper>",
  //        description =
  //            "credential helper for communicating with base image registry, either a path to the
  // helper, or a suffix for an executable named `docker-credential-<suffix>`",
  //        scope = CommandLine.ScopeType.INHERIT)
  //    @SuppressWarnings("NullAway.Init") // initialized by picocli
  //    private String credentialHelper;
  ...
  //  /**
  //   * Returns the user configured credential helper for any registry during the build, this can
  // be
